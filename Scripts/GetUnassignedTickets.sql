...
BEGIN
	...
	SET NOCOUNT ON;
SELECT     Ticket.id_ticket, Ticket.comentarios, Ticket.fecha_asignacion, Ticket.fecha_cierre, Ticket.creado_por, Ticket.status, Departamento.descripcion + '-' + Departamento.area AS Expr1, Error.descripcion AS Error, 
                         Empleado.nombre
